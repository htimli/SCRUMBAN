...
export class ProjectPageComponent implements OnInit {
  ...
  constructor(
    ...
    private userStorieService: UserStoriesService
  ) {}
  ...
  getSprintToShow() {
    this.sprintToShow = this.hijo.getSprintSelected();
    this.projectService.getProjectSprint(this, this.sprintToShow).then(() => {
      this.userStorieService.updateTaskGroups(this.currentSprint);
    });
  }
}
